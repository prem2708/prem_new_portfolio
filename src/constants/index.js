      ...
      children: [
        {
          ...
          description: [
            ...
            "Think of it as your personal artist—generating high-quality visuals for projects, marketing, or fun.",
      ...
      children: [
        {
          ...
          description: [
            ...
            "Think of it as a digital business card—highlighting achievements, tech stack, and personality in one place.",
      ...
      children: [
        {
          ...
          description: [
           "AI Doctor is an intelligent health assistant that offers preliminary medical advice based on symptoms and user input.",
            ...
            "Think of it as your virtual doctor—providing quick consultations, reminders, and guidance for better health.",
...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I’m Prem 👋, a web developer who enjoys building sleek, interactive websites that actually work well.",
